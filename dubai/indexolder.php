...
themoon.style.top=Math.floor(200-150*cosvalue)+"px";  // 80last
...
document.getElementById('date').innerHTML="<?php echo date('D d M Y H:i'); ?>"; // Needs JS Date or TZ Correction
...
<div id="main">
	...
	<div id="inside">
		<div id="leftpanel">
			...
			<p><a href="#" onclick="hidemenu();">Hide the Menu</a></p>
		</div>
